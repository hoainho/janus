...
The Janus installer applies the Harness v0 operating files and folder
...
```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/nano-step/janus/main/scripts/install-harness.ps1"))) -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/nano-step/janus/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/nano-step/janus/main/scripts/install-harness.ps1"))) -Merge -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/nano-step/janus/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --refresh-agent-shim --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/nano-step/janus/main/scripts/install-harness.ps1"))) -Merge -RefreshAgentShim -Yes
```
